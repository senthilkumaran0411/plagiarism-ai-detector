...
try:
    ...
    raise ValueError(f"Failed to load AI detection model: {e}")
...
def detect_ai_written_text(text):
    ...
    try:
        ...
        raise ValueError(f"Error during AI text detection: {e}")
...
def google_search(query):
    ...
    try:
        ...
        raise ValueError(f"Error during Google search: {e}")
